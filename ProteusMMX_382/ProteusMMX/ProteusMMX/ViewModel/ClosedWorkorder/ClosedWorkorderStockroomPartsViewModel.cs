...
{
    public class ClosedWorkorderStockroomPartsViewModel : ViewModelBase, IHandleViewAppearing
    {
        #region Fields
        ...
        public ClosedWorkorderStockroomPartsViewModel(IAuthenticationService authenticationService, IFormLoadInputService formLoadInputService, ICloseWorkorderService closeWorkorderService)
        {
        ...
        public ClosedWorkorderStockroomPartsViewModel()
        {
