...
namespace ProteusMMX.ViewModel.SelectionListPagesViewModels
{
    ...
    public class AssignToListSelectionPageViewModel : ViewModelBase
    {
        #region Fields

        protected readonly IAuthenticationService _authenticationService;
        protected readonly IFormLoadInputService _formLoadInputService;
        protected readonly IAssignToService _assignToService;
        ...
        private async void OnItemSelectedAsync(object item)
        {
            if (item != null)
            {
                MessagingCenter.Send(item, MessengerKeys.AssignToRequested);
        ...
        public AssignToListSelectionPageViewModel(IAuthenticationService authenticationService, IFormLoadInputService formLoadInputService, IAssignToService assignToService)
        {
            _authenticationService = authenticationService;
            _formLoadInputService = formLoadInputService;
            _assignToService = assignToService;
        }
        ...
        async Task GetPickerItems()
        {
            ...
            {
                //OperationInProgress = true;
                ServiceOutput assignToResponse = null;

                assignToResponse = await _assignToService.GetAssignToEmployeeFacilityWise(UserID, PageNumber.ToString(), RowCount.ToString(), SearchText);

                if (assignToResponse != null && assignToResponse.employeesAssignedTo != null)
                {
                    var assingedToEmployees = assignToResponse.employeesAssignedTo;
