...
{
    public class CostCenterListSelectionPageViewModel : ViewModelBase
    {
        #region Fields

        protected readonly IAuthenticationService _authenticationService;
        protected readonly IFormLoadInputService _formLoadInputService;
        protected readonly ICostCenterService _costCenterService;
        ...
        public CostCenterListSelectionPageViewModel(IAuthenticationService authenticationService, IFormLoadInputService formLoadInputService, ICostCenterService costCenter)
        {
            _authenticationService = authenticationService;
            _formLoadInputService = formLoadInputService;
            _costCenterService = costCenter;
        }
        ...
        async Task GetPickerItems()
        {
            ...
            {
                //OperationInProgress = true;
                ServiceOutput costCenterResponse = null;
                costCenterResponse = await _costCenterService.GetCostCenters(UserID, PageNumber.ToString(), RowCount.ToString(), SearchText);
                if (costCenterResponse != null && costCenterResponse.assetWrapper != null && costCenterResponse.assetWrapper.costCenters != null)
                {
                    var costCenters = costCenterResponse.assetWrapper.costCenters;
                    await AddItemsToPickerItemCollection(costCenters);
                }
