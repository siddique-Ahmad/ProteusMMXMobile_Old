...
{
    public class TaskListSelectionPageViewModel : ViewModelBase
    {
        #region Fields
        ...
        ObservableCollection<TaskLookUp> _pickerItemCollection = new ObservableCollection<TaskLookUp>();

        public ObservableCollection<TaskLookUp> PickerItemCollection
        {
            get
            {
        ...
        TaskLookUp _nullItem = new TaskLookUp() { TaskID = null, TaskNumber = string.Empty, LaborCraftCode = string.Empty};
        public TaskLookUp NullItem
        {
            get
            {
                return _nullItem;
        ...
        private async void OnItemSelectedAsync(object item)
        {
            if (item != null)
            {
                MessagingCenter.Send(item, MessengerKeys.TaskRequested);
        ...
        public TaskListSelectionPageViewModel(IAuthenticationService authenticationService, IFormLoadInputService formLoadInputService, ITaskService taskService)
        {
        ...
        async Task GetPickerItems()
        {
            try
            {
               // OperationInProgress = true;
                ...
                {
                    var assingedToEmployees = taskResponse.workOrderWrapper.workOrderLabor.Tasks;
        ...
        private async Task AddItemsToPickerItemCollection(List<TaskLookUp> assignedToEmployees)
        {
