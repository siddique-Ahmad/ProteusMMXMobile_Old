...
{
    public class EmployeeListSelectionPageViewModel : ViewModelBase
    {
        #region Fields
        ...
        ObservableCollection<EmployeeLookUp> _pickerItemCollection = new ObservableCollection<EmployeeLookUp>();

        public ObservableCollection<EmployeeLookUp> PickerItemCollection
        {
            get
            {
        ...
        EmployeeLookUp _nullItem = new EmployeeLookUp() { EmployeeLaborCraftID = null, EmployeeName = string.Empty, EmployeeNumber = string.Empty };
        public EmployeeLookUp NullItem
        {
            get
            {
                return _nullItem;
        ...
        public EmployeeListSelectionPageViewModel(IAuthenticationService authenticationService, IFormLoadInputService formLoadInputService, ITaskService taskService)
        {
