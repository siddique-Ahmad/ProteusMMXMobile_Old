...
namespace ProteusMMX.ViewModel.SelectionListPagesViewModels
{
    ...
    public class WorkorderTypeListSelectionPageViewModel : ViewModelBase
    {
        #region Fields

        protected readonly IAuthenticationService _authenticationService;
        protected readonly IFormLoadInputService _formLoadInputService;
        protected readonly IWorkorderTypeService _workorderTypeService;
        ...
        private async void OnItemSelectedAsync(object item)
        {
            if (item != null)
            {
                MessagingCenter.Send(item, MessengerKeys.WorkorderTypeRequested);
        ...
        public WorkorderTypeListSelectionPageViewModel(IAuthenticationService authenticationService, IFormLoadInputService formLoadInputService, IWorkorderTypeService workorderTypeService)
        {
        ...
        async Task GetPickerItems()
        {
            ...
            {
                //OperationInProgress = true;
                ServiceOutput workorderTypeResponse = null;
                workorderTypeResponse = await _workorderTypeService.GetWorkorderType(UserID , PageNumber.ToString(), RowCount.ToString(), SearchText);
                if (workorderTypeResponse != null && workorderTypeResponse.WorkTypesDD != null)
                {
                    var workorderTypes = workorderTypeResponse.WorkTypesDD;
                    await AddItemsToPickerItemCollection(workorderTypes);
                }
