...
namespace ProteusMMX.ViewModel.SelectionListPagesViewModels
{
    ...
    public class MaintenanceCodeListSelectionPageViewModel : ViewModelBase
    {
        #region Fields
        ...
        private async void OnItemSelectedAsync(object item)
        {
            if (item != null)
            {
                MessagingCenter.Send(item, MessengerKeys.MaintenanceCodeRequested);
        ...
        public MaintenanceCodeListSelectionPageViewModel(IAuthenticationService authenticationService, IFormLoadInputService formLoadInputService, IMaintenanceCodeService maintenanceCodeService)
        {
        ...
        async Task GetPickerItems()
        {
            try
            {
                ...
                maintenanceCodeResponse = await _maintenanceCodeService.GetMaintenanceCode(PageNumber.ToString(), RowCount.ToString(), SearchText);
                if (maintenanceCodeResponse != null && maintenanceCodeResponse.MaintenanceCodesDD != null)
                {
                    ...
                    await AddItemsToPickerItemCollection(maintenanceCodes);
                }
