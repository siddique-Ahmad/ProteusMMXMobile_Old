...
{
    //class WorkorderStatusListSelectionPageViewModel
    //{
    //}

    public class WorkorderStatusListSelectionPageViewModel : ViewModelBase
    {
        #region Fields

        protected readonly IAuthenticationService _authenticationService;
        protected readonly IFormLoadInputService _formLoadInputService;
        protected readonly IWorkorderStatusService _workorderStatusService;
        ...
        private async void OnItemSelectedAsync(object item)
        {
            if (item != null)
            {
                MessagingCenter.Send(item, MessengerKeys.WorkorderStatusRequested);
        ...
        public WorkorderStatusListSelectionPageViewModel(IAuthenticationService authenticationService, IFormLoadInputService formLoadInputService, IWorkorderStatusService workorderStatusService)
        {
        ...
        async Task GetPickerItems()
        {
            ...
            {
               // OperationInProgress = true;
                ServiceOutput workorderStatusResponse = null;
                workorderStatusResponse = await _workorderStatusService.GetWorkorderStatus(UserID , PageNumber.ToString(), RowCount.ToString(), SearchText);
                if (workorderStatusResponse != null && workorderStatusResponse.WorkOrderStatusDD != null)
                {
                    var workorderStatus = workorderStatusResponse.WorkOrderStatusDD;
                    await AddItemsToPickerItemCollection(workorderStatus);
                }
        ...
        private async Task AddItemsToPickerItemCollection(List<ComboDD> costCenter)
        {
