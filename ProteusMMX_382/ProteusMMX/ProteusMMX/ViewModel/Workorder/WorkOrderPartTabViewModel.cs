...
{
    public class WorkOrderPartTabViewModel : ViewModelBase
    {
        #region Fields
        ...
        #region Methods
        public WorkOrderPartTabViewModel(IAuthenticationService authenticationService, IFormLoadInputService formLoadInputService)
        {
