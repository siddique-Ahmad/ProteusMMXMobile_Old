...
{
    public class RiskQuestionPageViewModel:ViewModelBase
    {
        ...
        public RiskQuestionPageViewModel(IAuthenticationService authenticationService, IInspectionService inspectionService, IWorkorderService workorderService, IFormLoadInputService formLoadInputService)
        {
        ...
        public async Task SetTitlesPropertiesForPage()
        {
            try
            {
                ...
                {
                    PageTitle = WebControlTitle.GetTargetNameByTitleName("RiskQuestion");
