...
{
    public class SearchWorkorderByAssetNumberViewModel:ViewModelBase
    {
        #region Fields
        ...
        public SearchWorkorderByAssetNumberViewModel(IAuthenticationService authenticationService, IFormLoadInputService formLoadInputService, IAssetModuleService assetService, IWorkorderService workorderService)
        {
        ...
        public async Task SetTitlesPropertiesForPage()
        {
                ...
                PageTitle = WebControlTitle.GetTargetNameByTitleName("SearchWorkOrderbyAsset");
        ...
        private async Task GetWorkorderCollection()
        {
            ...
            tnobj.IsAssetCallFrombarcodePage = true;
            ...
            //{
                await NavigationService.NavigateToAsync<SearchWorkorderByAssetNumberFromBarcodeViewModel>(tnobj);
            //}
            //else
            //{
