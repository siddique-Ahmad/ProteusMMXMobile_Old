...
{
    class ServiceRequestTabbedPageViewModel : ViewModelBase
    {
        #region Fields
        ...
        #region Methods
        public ServiceRequestTabbedPageViewModel(IAuthenticationService authenticationService, IFormLoadInputService formLoadInputService, INavigationService NavigationService)
        {
