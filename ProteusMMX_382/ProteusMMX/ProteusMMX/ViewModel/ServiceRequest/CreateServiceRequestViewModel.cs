...
{
    public class CreateServiceRequestViewModel : ViewModelBase, IHandleViewAppearing, IHandleViewDisappearing
    {
        #region Fields
        ...
        SubModule _serviceRequestDetailsControlsNew = new SubModule();
        public SubModule ServiceRequestDetailsControlsNew
        {
            get
            {
                return _serviceRequestDetailsControlsNew;
            }

            set
            {
                _serviceRequestDetailsControlsNew = value;
            }
        }
        ...
        public async Task CreateControlsForPage()
        {
            ...
            //                        {
            //                            ServiceRequestControlsNew = DetailsTab.listControls;
            //                            var Target = DetailsTab.listControls.FirstOrDefault(i => i.ControlName == "AssetID");
            //                            if (Target != null && Target.Expression == "E")
            //                            {
            //                                this.AssetIdIsVisible = true;

            //                            }
            //                            else if (Target.Expression == "V")
            //                            {
            //                                this.LocationIsEnable = false;
            //                                this.FacilityIsEnable = false;
            //                                this.AssetIsEnable = false;
        ...
        private void OnWorkorderRequesterRequested(object obj)
        {
            ...
            if (obj != null)
            {
                ...
                //}
                //SetControlBindingAccordingToControlType(View control, FormControl formControl);
        ...
        public async Task CreateServiceRequest()
        {
            try
            {
              ...
              RegexOptions.IgnoreCase);
                ...
                ServiceRequest.UserField1 = UserField1;
                ServiceRequest.UserField2 = UserField2;
                ServiceRequest.UserField3 = UserField3;
                ServiceRequest.UserField4 = UserField4;
                ServiceRequest.UserField5 = UserField5;
                ServiceRequest.UserField6 = UserField6;
                ServiceRequest.UserField7 = UserField7;
                ServiceRequest.UserField8 = UserField8;
                ServiceRequest.UserField9 = UserField9;
                ServiceRequest.UserField10 = UserField10;
                ServiceRequest.UserField11 = UserField11;
                ServiceRequest.UserField12 = UserField12;
                ServiceRequest.UserField13 = UserField13;
                ServiceRequest.UserField14 = UserField14;
                ServiceRequest.UserField15 = UserField15;
                ServiceRequest.UserField16 = UserField16;
                ServiceRequest.UserField17 = UserField17;
                ServiceRequest.UserField18 = UserField18;
                ServiceRequest.UserField19 = UserField19;
                ServiceRequest.UserField20 = UserField20;
                ServiceRequest.UserField21 = UserField21;
                ServiceRequest.UserField22 = UserField22;
                ServiceRequest.UserField23 = UserField23;
                ServiceRequest.UserField24 = UserField24;
                #endregion
                ...
                if (fdasignatureKey==true)
                {
                    if (AppSettings.User.RequireSignaturesForValidation == "True")
                    {
                        ...
                        var page = new CreateServiceRequestSignaturePage();
                    ...
                    else
                    {
                        ...
                        var response = await _serviceRequestService.CreateServiceRequest(serviceRequest);
                        if (response != null && bool.Parse(response.servicestatus))
                        {
                            DialogService.ShowToast(WebControlTitle.GetTargetNameByTitleName("Servicerequestsuccessfullycreated"), 2000);
