...
namespace ProteusMMX.Views.Common
{
    ...
    public partial class CreateServiceRequestSignaturePage : PopupPage
    {
        ...
        //    }
        //}
        public CreateServiceRequestSignaturePage()
        {
            InitializeComponent();
        ...
        private async void OK_Clicked(object sender, EventArgs e)
        {
            try
            {
                ...
                var response = await ServiceRequestService.CreateServiceRequest(serviceRequest);
