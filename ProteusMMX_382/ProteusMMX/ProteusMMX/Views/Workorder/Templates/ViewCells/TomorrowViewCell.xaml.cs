...
namespace ProteusMMX.Views.Workorder.Templates.ViewCells
{
    ...
    public partial class TomorrowViewCell : ViewCell
    {
        ...
        public TomorrowViewCell(ref object ParentContext)
        {
            InitializeComponent();
        ...
        public static readonly BindableProperty ParentContextProperty =
           BindableProperty.Create("ParentContext", typeof(object), typeof(TomorrowViewCell), null, propertyChanged: OnParentContextPropertyChanged);
        ...
        private static void OnParentContextPropertyChanged(BindableObject bindable, object oldValue, object newValue)
        {
            ...
            {
                (bindable as TomorrowViewCell).ParentContext = newValue;
            }
        }
